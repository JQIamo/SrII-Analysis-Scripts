...
ser = data(path)
run = Run(path)
pixelsizeDict = {"horizontal": 3.72*10**(-3), "grating": 4.8*10**(-3)*2}

camera = "grating"
sigma0 = 1.015*10**(-7) #mm^2
mass = 87.906*1.661*10**(-27) #kg
pixelsize = pixelsizeDict[camera]
...
x,imagex,poptx,z,imagez, poptz = oned_gaussian_fit_sub(optical_depth, False)
